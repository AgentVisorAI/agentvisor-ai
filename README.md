...
- **[Landing page](https://debugmode0.github.io/agent-bridge/)** — the story, in
...
- **[Security model](SECURITY.md)** — trust boundaries, controls, and how
  ...
  [advisory form](https://github.com/debugmode0/agent-bridge/security/advisories/new).
- **[Architecture](ARCHITECTURE.md)** · **[Benchmarks](BENCHMARKS.md)** ·
  **[Verification protocol](VERIFICATION.md)** — going deeper.
- **[API docs](https://debugmode0.github.io/agent-bridge/api/)** — Rust crate
