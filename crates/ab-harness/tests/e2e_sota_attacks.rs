...
//!
//! AgentBridge's defense is not to prevent the model from being manipulated
...
use ab_sandbox::{NativePolicy, PolicyDecision, PolicyEngine, Sandbox, SandboxConfig, ToolVerdict};
...
//    AgentBridge's defense: schema-validated arguments; a `sidenote`
...
//    mail goes to attkr@pwnd.com. AgentBridge doesn't inspect tool
...
//    user approval. AgentBridge can't stop the model from being tricked,
...
//    AgentBridge, the schema/policy layer does not silently strip these,
