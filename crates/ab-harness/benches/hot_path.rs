//! Criterion benchmarks for AgentBridge hot-path operations.
...
fn benchmark(c: &mut Criterion) {
    ...
    headers.insert("x-ab-session", HeaderValue::from_static("bench-session"));
    ...
    c.bench_function("receipt_sign", |bench| {
        ...
        bench.iter(|| {
            let body = ab_receipts::receipt::new_body(
