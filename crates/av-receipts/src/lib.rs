...
//!
//! Signing discipline: a Receipt is finalized **once, at
...
pub use receipt::{
    signing_message, CostSummary, Receipt, ReceiptBody, ReceiptError, ReceiptSubject, ToolCallSummary,
    RECEIPT_DOMAIN_TAG_V2, RECEIPT_VERSION,
};
