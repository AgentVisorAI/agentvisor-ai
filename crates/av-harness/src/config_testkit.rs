...
impl HarnessConfig {
    ...
    pub fn for_tests(upstream_url: &str, spool: &str, bridge: &str) -> Self {
        Self {
            ...
            identity_human_subject_pattern: None,
            backends: Vec::new(),
            require_private_backends: false,
            tool_upstream_transport: default_tool_upstream_transport(),
            mcp_allowed_origins: Vec::new(),
            intent_map: std::collections::BTreeMap::new(),
            require_intent_mapping: false,
            mission: None,
            missions: Vec::new(),
            intent_token_ttl_s: default_intent_token_ttl(),
            authzen: None,
            workload_identity: None,
            workload_identities: Vec::new(),
            token_exchange_enabled: false,
            token_exchange_seed_file: None,
            token_exchange_ttl_s: default_exchange_ttl(),
            operator_tokens: Vec::new(),
            introspection_tokens: Vec::new(),
            revocation_audit_per_minute: default_revocation_audit_per_minute(),
            otel_tenant_endpoint: None,
            otel_tenant_auth_file: None,
            otel_tenant_content: TenantContent::Redacted,
